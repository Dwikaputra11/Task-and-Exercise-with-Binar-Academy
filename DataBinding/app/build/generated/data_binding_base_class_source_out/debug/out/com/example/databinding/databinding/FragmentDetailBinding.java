...
public final class FragmentDetailBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvTextFragment;

  private FragmentDetailBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextView tvTextFragment) {
    this.rootView = rootView;
    this.tvTextFragment = tvTextFragment;
  }
  ...
  public static FragmentDetailBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.tvTextFragment;
      TextView tvTextFragment = ViewBindings.findChildViewById(rootView, id);
      if (tvTextFragment == null) {
        break missingId;
      }

      return new FragmentDetailBinding((ConstraintLayout) rootView, tvTextFragment);
    }
